...
const Canvas2Image = (function () {
  ...
  function scaleCanvas(canvas, width, height) {
    ...
    //retCtx.save();,
    //retCtx.globalCompositeOperation = "destination-out";
    //retCtx.globalCompositeOperation = "destination-over";
    //retCtx.fillStyle = "rgba(0,0,0,1)";
